...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::player::set_dsp_config,
            commands::player::get_dsp_config,
            commands::player::list_dsp_processors,
            ...
            commands::classification::get_console_catalog,
            commands::classification::get_classification_overrides,
            commands::classification::set_folder_classification,
            commands::classification::set_track_classification,
            commands::classification::clear_classification,
            commands::classification::get_unclassified_folders,
            ...
            commands::covers::suggest_track_names,
            commands::covers::apply_track_names,
