// Copyright 2017-2021 qDot
// Copyright 2021 Tauri Programme within The Commons Conservancy
// SPDX-License-Identifier: Apache-2.0
// SPDX-License-Identifier: MIT
//
// Patched for Tunante: adds as_raw_ptr() to expose the internal
// AppIndicator pointer for use with app_indicator_set_secondary_activate_target().
...
impl AppIndicator {
  ...
  // --- Tunante patch: expose raw pointer ---

  /// Returns the raw C pointer to the underlying AppIndicator.
  ///
  /// This is needed to call libappindicator-sys functions that are not
  /// wrapped by this safe binding, such as
  /// `app_indicator_set_secondary_activate_target()`.
  pub fn as_raw_ptr(&self) -> *mut AppIndicatorRaw {
    self.air
  }
}
